...
# PnP: PEW social-sparsity plug-and-play; SPADE: stereo A-SPADE (eps/s scale with the window).
PRESETS = {
    "fast": [("pnp", 93, dict(n_iter=200))],
    "normal": [("pnp", 93, dict(n_iter=400)), ("spade", 93, {})],
    "high": [("pnp", 93, dict(n_iter=400)), ("pnp", 46.4, dict(n_iter=400)),
             ("spade", 93, {}), ("spade", 186, {})],
    "best": [("pnp", 93, dict(n_iter=400)), ("pnp", 46.4, dict(n_iter=400)), ("pnp", 186, dict(n_iter=400)),
             ("spade", 93, {}), ("spade", 46.4, {}), ("spade", 186, {})],
}
...
def declip(y, sr, preset="normal", levels=None, chunk_s=20.0, ctx_s=1.5, fade_s=0.05,
           threads=None, verbose=True, progress=None):
    ...
    for kind, win_ms, extra in models:
        if kind == "pnp" and win_ms not in lam_refs:
            W = nice_len(win_ms * 1e-3 * sr)
            st = TightSTFT(W, W // 4)
